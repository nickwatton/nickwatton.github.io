...
(function(){
    ...
    function resizeCanvas(){
        ...
        depthOffset = canvas.width * .5;
        heightOffset = canvas.height * .5;
        /*canvas.width = width;
    ...
    var wavePeak=.55, wavePeakStep=.001;
    function draw()
    {
        ...
        for(var loop=system1.particles.length, j=0; j<loop; j+=1) {
            ...
            y2d_2 = (particle2.y * scale2) + heightOffset + (Math.sin(particle2.theta*wavePeak)*20) * Math.sin(particle2.theta*3) * (Math.cos(particle2.theta*wavePeak)*2);
