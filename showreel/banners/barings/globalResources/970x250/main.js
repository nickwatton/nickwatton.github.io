				...
				**/
			    ...
			    case 1:
		            if (readyToRun(0.6)) {
		                ...
		                // map
		                TweenLite.from(objs[11], .5, { x:150, y:-10, delay:.5 });
		        ...
		        case 2:
		            if (readyToRun(1.3)) {
		                ...
		                // glasses DROP
		                TweenLite.from(objs[5], .6, { y:-180, scaleX:2.5, scaleY:2.5, ease:Power1.easeIn });
		                TweenLite.from(objs[5], .1, { alpha:0 });

		                // clipboard
		                TweenLite.from(objs[3], 1.3, { x:-10, y:105, delay:.2 });
		                TweenLite.from(objs[3], .1, { alpha:0, delay:.2 });

		                // pencil
		                TweenLite.from(objs[8], .75, { y:70, ease:Power1.easeOut, delay:.8 });
		                TweenLite.from(objs[8], .1, { alpha:0, delay:.8 });

		                // gps DROP
		                TweenLite.from(objs[6], .5, { x:250, y:-10, scaleX:2.5, scaleY:2.5, ease:Power1.easeIn, ease:Power1.easeIn, delay:.5 });
		        ...
		        case 3:
		            if (readyToRun(2)) {
		                ...
		                // photos
		                TweenLite.from(objs[9], .6, { x:-150, y:-30, rotation:20, ease:Power1.easeOut });
		                ...
		                // beanbag
		                TweenLite.from(objs[10], .6, { y:-100, ease:Power1.easeIn, delay:.1});
		                TweenLite.from(objs[10], .1, { alpha:0, delay:.1 });

		                // beans
		                TweenLite.from(objs[1], .3, { y:-130, delay:.7});
		        ...
		        case 4:
		            if (readyToRun(2.9)) {
		                ...
		                // cards
		                TweenLite.from(objs[12], .8, { x:105, rotation:10, ease:Power1.easeOut, delay:.2 });
