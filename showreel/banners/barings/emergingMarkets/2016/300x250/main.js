(function(){
	...
	function runSequencer() {
        ...
        function buildTimeline(){
			...
			addToTimeline(	{id:objs[2], time:rollingTime+=.2, duration:.8, from:true, props:{x:-30, y:200, scaleX:2.5, scaleY:2.5, ease:easeInSine}} );
			addToTimeline(	{id:objs[2], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[15], time:rollingTime+=.4, duration:.6, from:true, props:{y:-54, ease:easeOutSine}} );
			addToTimeline(	{id:objs[15], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[9], time:rollingTime+=.2, duration:.6, from:true, props:{y:82, ease:easeOutSine}} );
			addToTimeline(	{id:objs[9], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[12], time:rollingTime+=.2, duration:.8, from:true, props:{y:140, x:-30, scaleX:3, scaleY:3, ease:easeInSine}} );
			addToTimeline(	{id:objs[12], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[16], time:rollingTime+=.5, duration:.7, from:true, props:{y:110, scaleX:3, scaleY:3, ease:easeInSine}} );
			addToTimeline(	{id:objs[16], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[0], time:rollingTime, duration:.8, from:true, props:{x:-68, y:10, rotation:-30}} );
			addToTimeline(	{id:objs[0], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[8], time:rollingTime+=.3, duration:.4, from:true, props:{y:-110, scaleX:2.5, scaleY:2.5, ease:easeInSine}} );
			addToTimeline(	{id:objs[8], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[3], time:rollingTime, duration:.8, from:true, props:{x:39}} );
			addToTimeline(	{id:objs[3], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[11], time:rollingTime+=.1, duration:.5, from:true, props:{y:-30, scaleX:2, scaleY:2, ease:easeInSine}} );
			addToTimeline(	{id:objs[11], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[1], time:rollingTime+=.1, duration:.8, from:true, props:{y:100, scaleX:2.5, scaleY:2.5, rotation:-30, ease:easeInSine}} );
			addToTimeline(	{id:objs[1], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[5], time:rollingTime+=.1, duration:.5, from:true, props:{x:-30, y:-70, scaleX:3.5, scaleY:3.5, ease:easeInSine}} );
			addToTimeline(	{id:objs[5], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[7], time:rollingTime+=.1, duration:.5, from:true, props:{x:30, y:-70, scaleX:3.5, scaleY:3.5, ease:easeInSine}} );
			addToTimeline(	{id:objs[7], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[4], time:rollingTime+=.2, duration:.4, from:true, props:{x:-20, y:-35, scaleX:3.5, scaleY:3.5, ease:easeInSine}} );
			addToTimeline(	{id:objs[4], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[6], time:rollingTime+=.1, duration:.4, from:true, props:{x:20, y:-35, scaleX:3.5, scaleY:3.5, ease:easeInSine}} );
			addToTimeline(	{id:objs[6], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[14], time:rollingTime, duration:.6, from:true, props:{y:-35, rotation:-10, rotation:-20, ease:easeOutSine}} );
			addToTimeline(	{id:objs[14], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[13], time:rollingTime, duration:.8, from:true, props:{x:100}} );
			addToTimeline(	{id:objs[13], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );

			addToTimeline(	{id:objs[10], time:rollingTime, duration:.8, from:true, props:{x:120, y:90, scaleX:2.5, scaleY:2.5, rotation:30, ease:easeInSine}} );
			addToTimeline(	{id:objs[10], time:rollingTime, duration:.1, from:true, props:{alpha:0}} );


			addToTimeline(	{id:tA, time:rollingTime+=1.7, duration:0.5, from:true, props:{y:170, ease:easeInSine}} );
			addToTimeline(	{id:tA, time:rollingTime, duration:0, props:{alpha:1}} );

			addToTimeline(	{id:t1, time:rollingTime+=.5, duration:.75, props:{alpha:1}} );
