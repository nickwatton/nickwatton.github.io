(function(){
	...
	function runAnimation(){
		...
		function buildAnimation(){
			// addToTimeline( {id:pack1, time:rollingTime+=.0, alpha:1, duration:.5 } );
			addToTimeline( {id:upper, time:rollingTime+=.5, alpha:1, duration:.75 } );
			addToTimeline( {id:txt1, time:rollingTime+=1.5, alpha:1, duration:.75 } );
			addToTimeline( {id:lower, time:rollingTime+=1.5, alpha:1, duration:.75  } );
			
			addToTimeline( {id:pack2, time:rollingTime+=5, alpha:1, duration:.75 } );
			addToTimeline( {id:txt1, time:rollingTime, alpha:-1, duration:.5 } );
			addToTimeline( {id:pack1, time:rollingTime+=.5, alpha:-1, duration:.5 } );
			addToTimeline( {id:txt2, time:rollingTime+=.5, alpha:1, duration:.75 } );
		}
