(function(){
	...
	function runAnimation(){
		...
		function buildAnimation(){
			addToTimeline( {id:fr1_1, time:rollingTime+=.01, alpha:1, top:50, ease:easeOutSine, duration:.75 } );
			addToTimeline( {id:fr1_2, time:rollingTime+=.5, alpha:1, duration:.75 } );
			...
			addToTimeline( {id:fr2_3, time:rollingTime+=.75, alpha:1, duration:.75 } );
		}
