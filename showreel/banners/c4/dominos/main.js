(function(){
	...
	function runAnimation(){
		...
		function buildAnimation(){
			addToTimeline( {id:fr1_4, time:rollingTime+=.25, alpha:1, ease:easeOutBounce, duration:.5 } );
			addToTimeline( {id:fr1_1, time:rollingTime+=.5, alpha:1, top:50, ease:easeOutSine, duration:.75 } );
			addToTimeline( {id:fr1_2, time:rollingTime+=.75, alpha:1, duration:.75 } );
			addToTimeline( {id:fr1_3, time:rollingTime+=.5, alpha:1, duration:.75 } );
			
			addToTimeline( {id:fr1_4, time:rollingTime+=4, alpha:-1, ease:easeInBounce, duration:.5 } );
			addToTimeline( {id:fr1_1, time:rollingTime+=.25, alpha:-1, top:-50, ease:easeOutSine, duration:.5 } );
			addToTimeline( {id:fr1_2, time:rollingTime+=.1, alpha:-1, top:-50, ease:easeOutSine, duration:.5 } );
			addToTimeline( {id:fr1_3, time:rollingTime+=.1, alpha:-1, top:-50, ease:easeOutSine, duration:.5 } );

			addToTimeline( {id:fr2_1, time:rollingTime+=1, alpha:1, top:50, ease:easeOutSine, duration:.75 } );
			addToTimeline( {id:fr2_2, time:rollingTime+=1, left:150, ease:easeOutBounce, duration:.75 } );
		}
