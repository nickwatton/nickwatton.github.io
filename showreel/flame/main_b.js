...
(function(){
    ...
    var wrapper, canvas, ctx, width=500, height=250, Tau=Math.PI*2,
        ...
        factorA_tweenObj = {count:0, start:.53, end:1, duration:height-4}, 
        factorA, factorB, factorBAMod=.795, factorC=2.79,
        center,
    ...
    function update(){
        ...
        if(factorA_tweenObj.count < factorA_tweenObj.duration){
            ...
            factorB=1/(factorA*factorBAMod);
        }
    }

    function draw(){
        var rgb0,rgb1,rgb2;
        // var factorB=1/(factorA*.8), factorC=2.6;
