...
(function(){
    ...
    var wrapper, canvas, ctx, width=680, height=500, Tau=Math.PI*2,
        ...
        prevX=width*.5, prevY=height*.5, mouseX=prevX, mouseY=prevY, nextX, nextY,
        followDelayFactor=.1,
        lineAngleRadians, ribbonWidth, 

        ptA={x:0, y:0}, ptB={x:0, y:0}, 
        tempPtA, tempPtB, 
        prevTempPtA={x:0,y:0}, prevTempPtB={x:0,y:0},

        dx, dy, len,

        repaintColour="rgba(255, 255, 255, 0.2)", ribbonColour="#dd3399",
